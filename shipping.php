<?php
	...
	*/
    ...
    if($_POST['meal']=='pav'){
    $markFlowPaymentArray['transactions'][0]['item_list']['items'][0]['price'] = '$3.99';

    }else if ($_POST['meal']=='newcomb'){
    $markFlowPaymentArray['transactions'][0]['item_list']['items'][0]['price'] = '$5.99';

    }else{
            $markFlowPaymentArray['transactions'][0]['item_list']['items'][0]['price'] = '$4.99';

    }

	$markFlowPaymentArray['transactions'][0]['amount']['total'] = (float)$markFlowPaymentArray['transactions'][0]['item_list']['items'][0]['price'] + (float)'.50';
